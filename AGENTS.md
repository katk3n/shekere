...
When performing a release, follow the procedures specified in the dedicated skill file `.agents/skills/release/SKILL.md` to ensure safe autonomous processing by the AI agent.
